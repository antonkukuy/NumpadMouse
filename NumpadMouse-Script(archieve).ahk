...
| AppsKey             | Right mouse button click.          |
...
MouseWheelSpeed = 1
MouseWheelAccelerationSpeed = 55
MouseWheelMaxSpeed = 65
...
Hotkey, *RControl, ButtonLeftClickIns   
Hotkey, *`,, ButtonMiddleClick   
Hotkey, *NumpadClear, ButtonMiddleClickClear   
Hotkey, *AppsKey, ButtonRightClick   
